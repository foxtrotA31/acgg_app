...
<div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
        ...
        <div class="flex items-center justify-center">
            ...
            <button id="search-btn" class="ml-1 px-4 py-2 text-white btn-color rounded-lg hover:bg-indigo-600">Search</button>
        </div>
        <div id="sensor-details" class="w-full">
            <div class="flex flex-col items-center justify-center">
            <img class="h-1/4 w-1/4 mt-16" src="{{URL('images/acgg_logo.png')}}" alt="ACGGLogo" />
            <p class="text-2xl mt-4 mb-16 green-txt font-semibold">Enter Sensor Device No. Above.</p>
            </div>
        </div>
</div> 
</x-user-layout>
