...
<div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full"> 
    ...
    @csrf
        ...
        <div class="flex items-center p-4">
            ...
            <input type="text" name="plant_name" value="{{old('plant_name')}}" class="w-60 ml-3 py-2 px-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('plant_name') border-red-500 @enderror" >
            @error('plant_name')
        ...
        <div class="flex items-center p-4">
            <label for="pc_id" class="text-2xl">Plant Category</label>
            <select name="pc_id" id="pc_id" value="{{old('pc_id')}}" class="w-60 ml-3 py-2 px-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
        ...
        <button class="bg-green-600 hover:bg-cyan-700 focus:bg-cyan-700 text-white rounded-lg px-3 py-3 font-semibold">Add Plant</button>
        </div>
    </form>
</div>
</x-user-layout>
